  ...
  return new Promise(function(resolve) {
    resolve({
      ...
      saasLanding: {
        ...
        banner_subtitle: 'Are you tired of filling in whitelists for new IDOs and get nothing?',
        ...
        feature_title1: 'At least in',
        feature_titlestrong1: 'the first months',
        feature_desc1_1: `According to our prediction models we think we can offer 5x of the initial <b> investment </b>, but with all the euphoria of this bull run of 2021, and <b>so many of the</b> projects launching, doing 100x or more,
