  ...
  >
    ...
    <div class="popover violeta-var">
      <v-list class="mode-menu">
        <v-subheader>{{ $t('saasLanding.header_theme') }}</v-subheader>
        <v-list-item>
          <v-list-item-content>
            <div class="flex-menu">
              <label>
                {{ $t('saasLanding.header_light') }}
              </label>
              <v-switch
                v-model="dark"
                label=""
      ...
      <v-list class="lang-menu">
        <v-subheader>{{ $t('saasLanding.header_language') }}</v-subheader>
        <v-list-item
